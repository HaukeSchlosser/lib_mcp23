 ...
 * 
 * @return int16_t  Returns the read byte (0-255) on success, or a negative error code on failure.
 */
 ...
 * @param pin       Pin number (0-7) within the register.
 * 
 * @return int8_t   Returns the pin value (0 or 1) on success, or a negative error code on failure.
 */
...
/**
 * @brief Enables or disables LED on all pins of the MCP23009.
 *
 * @param dev           Pointer to the MCP23009 device handle.
